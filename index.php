<?php
$assetUrl = is_dir(__DIR__ . '/frontend') ? 'frontend/' : '';
$backendUrl = 'backend/';
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo $assetUrl; ?>asset/Teks paragraf Anda (2).png">
...
<body>
    ...
    <nav class="navbar">
        <div class="container">
            <div class="nav-logo">
                <img src="<?php echo $assetUrl; ?>asset/Rule Book TAN.png" alt="Logo Pelarian Timun Mas">
            </div>
    ...
    <section id="home" class="hero">
        <div class="hero-content">
            <div class="hero-logo">
                <img src="<?php echo $assetUrl; ?>asset/Teks paragraf Anda (2).png" alt="Logo Timun Mas">
            </div>
        ...
        <div class="container">
            ...
            <div class="about-card">
                <div class="about-image">
                    <img src="<?php echo $assetUrl; ?>asset/WhatsApp Image 2026-02-02 at 11.19.54.jpeg" alt="Valensia Chiko Varianto">
                </div>
            ...
            <div class="game-grid">
                <div class="game-card">
                    <div class="game-image">
                        <img src="<?php echo $assetUrl; ?>asset/Papan.png" alt="Pelarian Timun Mas">
                    </div>
                    <div class="game-content">
                        ...
                        <a href="<?php echo $assetUrl; ?>pages/cara_bermain.php" class="btn btn-primary">Cara Bermain</a>
                    </div>
                </div>
            </div>
        </div>
