...
$login = mysqli_query($koneksi, "SELECT * FROM tb_admin WHERE user_name='$user_name' AND password='$password'");
...
if ($jumlah_login == 0) {
    ...
    <body>
    <script>
        showAlert('success', 'Login Berhasil', 'Selamat datang <?php echo $data_login['nama_admin']; ?>!', 'index.php');
    </script>
    </body>
    </html>
    <?php
